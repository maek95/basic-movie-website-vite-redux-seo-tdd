...
export default function AboutPage() {
  ...
  useEffect(() => {
    if (popularMoviesArr && popularMoviesArr.length > 0) {
      ...
      if (
        popularImgSrcArr.length < popularMoviesArr.length &&
        popularImgSrcArr.length < 10
      ) {
        popularMoviesArr.map((movie, index) => {
          if (index < 10) {
            setPopularImgSrcArr((prevArr) => [
              ...prevArr,
  ...
  return (
    <div className="min-h-dvh">
      <Helmet>
        ...
        <meta
          name="description"
          content="About basic-movie-page - a movie page using TMDB API"
        />
        <meta property="og:title" content="Movies - AboutPage" />
        <meta
          property="og:description"
          content="Read about us - movie page using TMDB API"
        />
        ...
        <meta
          ...
          content="About us - movie page using TMDB API"
        />
        <meta
          name="twitter:image"
          content={`${import.meta.env.VITE_HOST}/basic-movie-page-logo.png`}
      ...
      <main className="p-4">
        ...
        <div className="flex w-full flex-wrap justify-center ">
          {popularImgSrcArr &&
            popularImgSrcArr.length > 0 &&
            popularImgSrcArr.map((movieImgSrc, index) => {
